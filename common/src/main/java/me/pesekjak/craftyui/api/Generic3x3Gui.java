 ...
 */
public class Generic3x3Gui implements IGeneric3x3Gui {

    @Delegate
    private final IGeneric3x3Gui delegatingGui;

    public Generic3x3Gui(@NotNull Player player, BaseComponent @NotNull [] title) {
        ...
        delegatingGui = provider.provideGeneric3x3(this, player, title);
    }
