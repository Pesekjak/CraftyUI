...
import me.pesekjak.craftyui.guis.IGeneric9x1Gui;
 ...
 */
public class Generic9x1Gui implements IGeneric9x1Gui {

    @Delegate
    private final IGeneric9x1Gui delegatingGui;

    public Generic9x1Gui(@NotNull Player player, BaseComponent @NotNull [] title) {
        ...
        delegatingGui = provider.provideGeneric9x1(this, player, title);
    }
