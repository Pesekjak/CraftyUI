...
import me.pesekjak.craftyui.guis.IGeneric9x5Gui;
 ...
 */
public class Generic9x5Gui implements IGeneric9x5Gui {

    @Delegate
    private final IGeneric9x5Gui delegatingGui;

    public Generic9x5Gui(@NotNull Player player, BaseComponent @NotNull [] title) {
        ...
        delegatingGui = provider.provideGeneric9x5(this, player, title);
    }
